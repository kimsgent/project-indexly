...
| Search export | [`src/indexly/export_utils.py`](../../../src/indexly/export_utils.py) and export helpers in CLI modules | User-visible writes in text/JSON/PDF-related flows. Destination, collisions, optional PDF capability, temporary file, and exact result identity need contracts. |
