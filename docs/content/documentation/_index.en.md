...
- Local performance evidence: [Performance Diagnostics and Optimization](performance-guide.md)
...
| Measure search-database performance against local evidence | [Performance Diagnostics and Optimization](performance-guide.md) |
